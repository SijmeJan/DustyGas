...
def allow_periodic(repo_dir):
    ...
    lines[len(lines):len(lines)] = \
      ['\n',
       ...
       '  const int                                          solverNumber,\n',
       '  CellInfo&                                          cellInfo) {\n',
       '  int madeAdjustment = _solver->AdjustPeriodic(solverNumber, cellInfo);\n',
       '  int madeAdjustmentLimiter = _limiter->AdjustPeriodic(solverNumber, cellInfo);\n',
       #'  if (madeAdjustment) {\n',
       ...
       '  _limiter->PlotPeriodic(solverNumber, cellInfo);\n',
       '}\n',
       '\n',
