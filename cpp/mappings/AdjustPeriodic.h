/**
 * This file is based on part of the ExaHyPE project.
 *
 * Released under the BSD 3 Open Source License.
 * For the full license text, see LICENSE.txt
 **/

#ifndef EXAHYPE_MAPPINGS_AdjustPeriodic_H_
#define EXAHYPE_MAPPINGS_AdjustPeriodic_H_
...
/**
 * Update the periodic cells; i.e. ghost cells in ADER-DG.
 *
 * <h2>ADER-DG</h2>
 * We run over all cells of the local spacetree and call AdjustSolution
 *
 * All this is done in enterCell().
 *
 * <h2>Finite Volumes</h2>
 * Should not do anything because it has genuine ghost cells
 *
 * @author Sijme-Jan Paardekooper
 */
class exahype::mappings::AdjustPeriodic {
private:
  /**
